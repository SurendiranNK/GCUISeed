...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $urlRouterProvider.otherwise("tables/historical");
   /*$urlRouterProvider.otherwise("forms/advanced_plugins");*/
    ...
    $stateProvider
        ...
        .state('forms.colas_de_espera', {
            url: "/colas_de_espera",
            templateUrl: "views/colas_de_espera.html",
            data: { pageTitle: 'Colas De Espera' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('tables.historical', {
            url: "/historical",
            templateUrl: "views/historical.html",
            data: { pageTitle: 'Historical' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
